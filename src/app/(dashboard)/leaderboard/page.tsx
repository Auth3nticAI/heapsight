      ...
      <header className="border-b border-white/[0.05] px-4 sm:px-6 py-4">
        <div className="max-w-4xl mx-auto">
          <div className="lg:hidden md:pl-12">
            ...
            <p className="text-xs text-[#AFBCD5]/50 font-mono mt-0.5">Compete globally</p>
          </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6">
        ...
        <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-3">
          {[
            ...
            <div key={tip.title} className="p-4 rounded-xl border border-white/[0.05] bg-[#071528] text-center">
              <div className="text-2xl mb-2">{tip.icon}</div>
              <p className="text-xs font-semibold text-white mb-1">{tip.title}</p>
              <p className="text-[9px] font-mono text-[#AFBCD5]/50">{tip.desc}</p>
            </div>
          ))}
        </div>
      </div>
