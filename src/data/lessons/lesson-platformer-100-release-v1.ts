...
export const lessonPlatformer100: Lesson = {
  id: "platformer-100-release-v1",
  title: "Release v1.0",
  description: "Milestone: tag v1.0 export build artifact project complete.",
  order: 100,
  xpReward: 400,
  tier: "pro",
  ...
  part2: {
    title: "Game Builder: Release v1.0",
    type: "game_builder",
    instructions: `# Game Builder: Release v1.0\n\nTODO: Add instructions.`,
    starterCode: `// TODO: Add starter code`,
    solutionCode: `// TODO: Add solution code`,
    tests: [
