...
export const lessonShooter100: Lesson = {
  id: "shooter-100-ship-export-ready",
  title: "Ship: Export Ready",
  description: "Portfolio-grade space shooter.",
  order: 100,
  xpReward: 500,
  tier: "pro",
  concepts: ["ship", "export", "portfolio", "capstone"],
  part1: {
...
## Mental Model
Shipping is a discipline. Every professional project passes these checks. Portfolio-grade space shooter.

## What Breaks Without This
Without the final pass, the repo looks like a student project, not a portfolio piece.

## The Fix: Ship: Export Ready
Implement the ship export ready concept in console output, then apply it to the running game in Part 2.

## Your Task
Complete the TODOs to produce the expected console output.

## Beginner Trap
**Shipping without testing on a clean machine.** "Works on my machine" is not shipping evidence. Build from a clean checkout, run on a machine without your dev environment, verify the game starts and plays correctly.

## Elite Insight
Valve tests every Steam release on standardized hardware profiles. The clean-room build test is the final quality gate. Your export-ready test follows the same principle: verify the build works outside your dev environment.
...
int main(){
    ...
    // TODO: print all ship export ready diagnostics
    return 0;
}`,
...
int main(){
    cout<<"Ship: Export Ready"<<endl;
    cout<<"Ship: HeapSight Shooter v1.0"<<endl;
    cout<<"Portfolio: ECS+DOD+determinism"<<endl;
    cout<<"Systems: 8 total"<<endl;
    cout<<"Gates: A=heap B=replay C=warnings"<<endl;
    cout<<"Ship: EXPORT READY"<<endl;
    return 0;
}`,
    tests: [
      { id: "t1", description: "ship-export-ready line 1", expectedOutput: "Ship: Export Ready", isPattern: false },
      { id: "t2", description: "ship-export-ready line 2", expectedOutput: "Ship: EXPORT READY", isPattern: false },
    ],
    hints: [
...
Add ship export ready to the running game.

## Did It Work?
Console shows the new ship export ready output alongside all previous outputs. Canvas shows the game with the new infrastructure active.`,
    starterCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
void print_L91_100(){
    ...
    cout<<"TestRNG: seed=42 first=1013904265"<<endl;
    cout<<"TestRNG: 5 values deterministic"<<endl;
    cout<<"TestRNG: PASS"<<endl;
    cout<<"TestPool: alloc slot=0 OK"<<endl;
    cout<<"TestPool: free+reuse slot=0 OK"<<endl;
    cout<<"TestPool: PASS"<<endl;
    cout<<"TestAABB: overlap=true OK"<<endl;
    cout<<"TestAABB: no_overlap=false OK"<<endl;
    cout<<"TestCollision: PASS"<<endl;
    cout<<"GATE C: Zero Warnings"<<endl;
    cout<<"CompilerFlags: -Wall -Wextra -Werror"<<endl;
    cout<<"Warnings: 0"<<endl;
    cout<<"GATE C: PASSED"<<endl;
    cout<<"Pattern: zero-warnings"<<endl;
    cout<<"README: sections=4"<<endl;
    cout<<"Quickstart: make && ./shooter"<<endl;
    cout<<"DocComplete: true"<<endl;
    cout<<"Screenshot: gameplay.png 800x450"<<endl;
    cout<<"Screenshot: boss.png 800x450"<<endl;
    cout<<"ScreenshotCount: 2"<<endl;
    cout<<"ContentAudit: waves=10 types=3 powerups=3 boss=1"<<endl;
    cout<<"ContentPass: minimum met"<<endl;
    cout<<"Quality: ship-ready"<<endl;
    cout<<"Release: v1.0 tagged"<<endl;
    cout<<"Checklist: tests=pass warnings=0 docs=complete"<<endl;
    cout<<"ReleaseReady: true"<<endl;
}
...
void hudSystem(World& w){
    DrawText("** RELEASE CHECKLIST **",SCREEN_W/2-180,8,18,GOLD);
...
// TODO: Add ship export ready — see instructions`,
    solutionCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
void hudSystem(World& w){
    DrawText("** SHIP: EXPORT READY **",SCREEN_W/2-180,8,18,GOLD);
    DrawText(TextFormat("Score: %d x%d",w.score,1+w.combo_hits/10),10,38,18,WHITE);
    DrawText(TextFormat("Wave:  %d",w.wave),10,62,18,WHITE);
    DrawText(TextFormat("HP: %d/%d",w.player_hp,w.player_max_hp),10,86,18,WHITE);
    DrawText(TextFormat("Lives: %d",w.lives),10,110,18,PINK);
...
int main(){
    ...
    tests: [
      { id: "g1", description: "ship-export-ready line 1", expectedOutput: "Ship: Export Ready", isPattern: false },
      { id: "g2", description: "ship-export-ready output", expectedOutput: "Ship: HeapSight Shooter v1.0", isPattern: false },
      { id: "g3", description: "ship-export-ready complete", expectedOutput: "Ship: EXPORT READY", isPattern: false },
