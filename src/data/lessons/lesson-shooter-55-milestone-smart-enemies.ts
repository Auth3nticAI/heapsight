...
export const lessonShooter55: Lesson = {
  id: "shooter-55-milestone-smart-enemies",
  title: "Milestone: Smart Enemies",
  description: "Multiple AI patterns create varied enemy behavior.",
  order: 55,
  xpReward: 300,
  tier: "pro",
  concepts: ["milestone", "AI variety", "behavior patterns", "smart enemies"],
  part1: {
    title: "Concept: Milestone: Smart Enemies",
    type: "concept",
    instructions: `# Milestone: Smart Enemies

## Mental Model
Multiple AI types create variety. Some enemies fall straight (idle), some aim at you (linear), some weave (wave). The AI type is just data — an integer per entity. The AI system reads it and picks behavior.

## What Breaks Without This
A single AI type means every wave feels identical. Multiple patterns create emergent combinations.

## The Fix: Milestone: Smart Enemies
Implement the milestone: smart enemies concept in console output, then apply it to the game in Part 2.

## Your Task
Complete the TODOs to produce the expected console output.

## Beginner Trap
**Testing AI with only one enemy type.** If all enemies use linear pursuit, there is no variety. The milestone requires at least two distinct behaviors (linear + wave) coexisting in the same wave.

## Elite Insight
Enemy variety is what separates a good shooter from a great one. Galaga had divebombers and formations. Your behavior system enables the same variety — different AI types create emergent gameplay patterns.

## Systems Thinking Connection
RPG uses data-driven enemy behaviors (L78). Crawler uses patrol/chase FSMs (L37). Your behavior-per-type system is the shooter version — each enemy type has a behavior ID that selects its movement pattern.`,
    starterCode: `#include <iostream>
using namespace std;
int main(){
    // TODO: print AITypes: 3 (linear,wave,idle)
    // TODO: print Milestone: SmartEnemies
    return 0;
}`,
...
int main(){
    ...
    tests: [
      { id: "t1", description: "milestone-smart-enemies line 1", expectedOutput: "AITypes: 3 (linear,wave,idle)" },
      { id: "t2", description: "milestone-smart-enemies line 2", expectedOutput: "Milestone: SmartEnemies" },
    ],
    hints: [
  ...
  part2: {
    title: "Build: Milestone: Smart Enemies",
    type: "game_builder",
    instructions: `# Build: Milestone: Smart Enemies

Add milestone: smart enemies to the running game.

## Did It Work?
Console shows the new milestone: smart enemies output. Canvas shows the updated game with the new feature active.`,
    starterCode: `#include <iostream>
#include "raylib.h"
using namespace std;
...
void hudSystem(World& w){
    DrawText("** L55: Advanced ECS **",SCREEN_W/2-180,8,18,GOLD);
...
int main(){
    ...
    tests: [
      { id: "g1", description: "milestone-smart-enemies line 1", expectedOutput: "AITypes: 3 (linear,wave,idle)" },
      { id: "g2", description: "milestone-smart-enemies line 2", expectedOutput: "Milestone: SmartEnemies" },
      { id: "g3", description: "gate D still passes", expectedOutput: "GATE D: PASSED" },
    ],
    hints: [
