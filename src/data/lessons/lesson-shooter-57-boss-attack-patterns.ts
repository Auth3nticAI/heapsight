...
export const lessonShooter57: Lesson = {
  id: "shooter-57-boss-attack-patterns",
  title: "Boss Attack Patterns",
  description: "Boss fires projectile patterns as data-driven attacks.",
  order: 57,
  xpReward: 100,
  tier: "pro",
  concepts: ["bullet patterns", "boss attacks", "pattern data", "projectile system"],
  part1: {
    title: "Concept: Boss Attack Patterns",
    type: "concept",
    instructions: `# Boss Attack Patterns

## Mental Model
Boss projectile patterns are data. A spiral: spawn N bullets evenly spaced around a circle. Each bullet gets vx=cos(angle)*speed, vy=sin(angle)*speed. Change N and you change the pattern. Change speed and you change difficulty.

## What Breaks Without This
A boss with no attacks is just a big target. Projectile patterns force the player to dodge AND shoot simultaneously.

## The Fix: Boss Attack Patterns
Implement the boss attack patterns concept in console output, then apply it to the game in Part 2.

## Your Task
Complete the TODOs to produce the expected console output.

## Beginner Trap
**Hardcoding attack patterns in if/else chains.** Each new pattern means more branches. Store patterns as data: { type: SPIRAL, bullet_count: 12, angle_step: 30, speed: 3.0 }. The attack system reads data, not code.

## Elite Insight
Bullet-pattern games (danmaku/bullet-hell) define attacks as data — angle, speed, count, timing. Touhou and Ikaruga encode hundreds of patterns without unique code for each. Your data-driven patterns follow the same philosophy.

## Systems Thinking Connection
RPG defines attack types in combat tables. Crawler defines enemy attacks as data (L39). Data-driven attack definitions are universal: designers create content by editing data, not by writing and debugging new code.`,
    starterCode: `#include <iostream>
using namespace std;
int main(){
    int pattern_count=8;
    int speed=3;
    // TODO: print BossAtk: spiral count=8 speed=3
    // TODO: print Patterns: 2 loaded
    return 0;
}`,
...
int main(){
    int pattern_count=8;
    int speed=3;
    cout<<"BossAtk: spiral count="<<pattern_count<<" speed="<<speed<<endl;
    cout<<"Patterns: 2 loaded"<<endl;
    return 0;
}`,
    tests: [
      { id: "t1", description: "boss-attack-patterns line 1", expectedOutput: "BossAtk: spiral count=8 speed=3" },
      { id: "t2", description: "boss-attack-patterns line 2", expectedOutput: "Patterns: 2 loaded" },
    ],
    hints: [
  ...
  part2: {
    title: "Build: Boss Attack Patterns",
    type: "game_builder",
    instructions: `# Build: Boss Attack Patterns

Add boss attack patterns to the running game.

## Did It Work?
Console shows the new boss attack patterns output. Canvas shows the updated game with the new feature active.`,
    starterCode: `#include <iostream>
#include "raylib.h"
using namespace std;
...
void collisionSystem(World& w){
    ...
    for(int i=0;i<MAX_BOSS_BULLETS;i++){
        ...
        if(ph){w.boss.bullet_active[i]=false;w.player_hp--;}
    }
...
void hudSystem(World& w){
    DrawText("** L57: Advanced ECS **",SCREEN_W/2-180,8,18,GOLD);
...
int main(){
    ...
    tests: [
      { id: "g1", description: "boss-attack-patterns line 1", expectedOutput: "BossAtk: spiral count=8 speed=3" },
      { id: "g2", description: "boss-attack-patterns line 2", expectedOutput: "Patterns: 2 loaded" },
    ],
    hints: [
