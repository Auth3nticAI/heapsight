...
export const lessonShooter58: Lesson = {
  id: "shooter-58-shield-component",
  title: "Shield Component",
  description: "Temporary invulnerability shield with timer-based decay.",
  order: 58,
  xpReward: 100,
  tier: "pro",
  concepts: ["shield", "timer component", "invulnerability", "time-limited"],
  part1: {
    title: "Concept: Shield Component",
    type: "concept",
    instructions: `# Shield Component

## Mental Model
A shield is a timer component. When active, the player is invulnerable. Each frame, the timer decrements. When it hits zero, the shield drops. This is the simplest time-limited component — duration in frames, nothing more.

## What Breaks Without This
Without shields, a single hit from a boss bullet pattern is devastating. The shield gives players a survival tool.

## The Fix: Shield Component
Implement the shield component concept in console output, then apply it to the game in Part 2.

## Your Task
Complete the TODOs to produce the expected console output.

## Beginner Trap
**Checking shield status in the damage function instead of the collision system.** The shield should prevent the collision response (damage), not just reduce it. Check shield before applying damage: if shielded, skip damage entirely.

## Elite Insight
Time-limited components (shields, buffs, invulnerability) are timer-driven: each frame, decrement the timer. When the timer hits zero, remove the component. This pattern applies to any temporary state in any game.

## Systems Thinking Connection
RPG uses timed status effects. Platformer uses invulnerability frames (L54). Crawler grants temporary buffs. Timer-based components are the universal pattern for temporary state — the implementation is identical across all paths.`,
    starterCode: `#include <iostream>
using namespace std;
int main(){
    int dur=180;
    bool active=true;
    // TODO: print Shield: dur=180 frames active=true
    // TODO: decrement dur, print ShieldDecay: 180->179
    return 0;
}`,
...
int main(){
    int dur=180;
    bool active=true;
    cout<<"Shield: dur="<<dur<<" frames active="<<(active?"true":"false")<<endl;
    dur--;
    cout<<"ShieldDecay: 180->"<<dur<<endl;
    return 0;
}`,
    tests: [
      { id: "t1", description: "shield-component line 1", expectedOutput: "Shield: dur=180 frames active=true" },
      { id: "t2", description: "shield-component line 2", expectedOutput: "ShieldDecay: 180->179" },
    ],
    hints: [
  ...
  part2: {
    title: "Build: Shield Component",
    type: "game_builder",
    instructions: `# Build: Shield Component

Add shield component to the running game.

## Did It Work?
Console shows the new shield component output. Canvas shows the updated game with the new feature active.`,
    starterCode: `#include <iostream>
#include "raylib.h"
using namespace std;
...
void hudSystem(World& w){
    DrawText("** L58: Advanced ECS **",SCREEN_W/2-180,8,18,GOLD);
...
int main(){
    ...
    tests: [
      { id: "g1", description: "shield-component line 1", expectedOutput: "Shield: dur=180 frames active=true" },
      { id: "g2", description: "shield-component line 2", expectedOutput: "ShieldDecay: 180->179" },
    ],
    hints: [
