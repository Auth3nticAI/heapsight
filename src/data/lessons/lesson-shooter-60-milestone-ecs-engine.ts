...
export const lessonShooter60: Lesson = {
  id: "shooter-60-milestone-ecs-engine",
  title: "Milestone: ECS Engine",
  description: "Full component/system/tag architecture verified.",
  order: 60,
  xpReward: 300,
  tier: "pro",
  concepts: ["milestone", "ECS completeness", "architecture proof", "GATE E"],
  part1: {
    title: "Concept: Milestone: ECS Engine",
    type: "concept",
    instructions: `# Milestone: ECS Engine

## Mental Model
GATE E certifies the full ECS engine: component flags for capabilities, systems in explicit order, AI behaviors as data, boss as complex entity, shield as time-limited component, tags for classification. This is a real architecture.

## What Breaks Without This
Without gate verification, architectural rot creeps in. GATE E proves the ECS is complete and correct.

## The Fix: Milestone: ECS Engine
Implement the milestone: ecs engine concept in console output, then apply it to the game in Part 2.

## Your Task
Complete the TODOs to produce the expected console output.

## Beginner Trap
**Declaring ECS complete without testing entity reuse.** Create 100 entities, destroy them all, create 100 more. If the second batch works identically, your ECS handles the full lifecycle. If not, your pool or ID system has a bug.

## Elite Insight
A complete ECS needs: entity creation, component attachment, system iteration, entity destruction, and slot reuse. Your milestone tests all five operations. Professional ECS frameworks test these with automated stress tests.

## Systems Thinking Connection
RPG reaches its architecture milestone at L40. Platformer and Crawler reach theirs at similar points. The ECS milestone proves your entity system can handle any number of entity types and behaviors without architectural changes.`,
    starterCode: `#include <iostream>
using namespace std;
int main(){
    cout<<"GATE E: ECS Engine"<<endl;
    // TODO: print Components, Systems, Tags, AITypes, BossPhases lines
    // Then: GATE E: PASSED and Pattern: ecs-engine
    return 0;
}`,
...
int main(){
    ...
    cout<<"AITypes: 3"<<endl;
    cout<<"BossPhases: 2"<<endl;
    cout<<"GATE E: PASSED"<<endl;
    cout<<"Pattern: ecs-engine"<<endl;
    return 0;
}`,
    tests: [
      { id: "t1", description: "milestone-ecs-engine line 1", expectedOutput: "GATE E: ECS Engine" },
      { id: "t2", description: "milestone-ecs-engine line 2", expectedOutput: "GATE E: PASSED" },
    ],
    hints: [
  ...
  part2: {
    title: "Build: Milestone: ECS Engine",
    type: "game_builder",
    instructions: `# Build: Milestone: ECS Engine

Add milestone: ecs engine to the running game.

## Did It Work?
Console shows the new milestone: ecs engine output. Canvas shows the updated game with the new feature active.`,
    starterCode: `#include <iostream>
#include "raylib.h"
using namespace std;
...
void hudSystem(World& w){
    DrawText("** GATE E: ECS ENGINE **",SCREEN_W/2-180,8,18,GOLD);
...
int main(){
    ...
    tests: [
      { id: "g1", description: "milestone-ecs-engine line 1", expectedOutput: "GATE E: ECS Engine" },
      { id: "g2", description: "milestone-ecs-engine line 2", expectedOutput: "GATE E: PASSED" },
      { id: "g3", description: "gate E header", expectedOutput: "GATE E: ECS Engine" },
      { id: "g4", description: "gate E passes", expectedOutput: "GATE E: PASSED" },
      { id: "g5", description: "gate E pattern", expectedOutput: "Pattern: ecs-engine" },
    ],
    hints: [
