...
export const lessonShooter61: Lesson = {
  id: "shooter-61-save-v1-versioned",
  title: "Save v1 Versioned",
  description: "Add version number to save format for schema evolution.",
  order: 61,
  xpReward: 200,
  tier: "pro",
  concepts: ["save format", "versioning", "schema evolution", "serialization"],
  part1: {
    title: "Concept: Save v1 Versioned",
    type: "concept",
    instructions: `# Save v1 Versioned

## Mental Model
A save file without a version number is a time bomb. The moment you change the format, every old save breaks. Version 1 of anything should start with a version field.

## What Breaks Without This
Without versioning, any format change destroys all existing saves. Players lose progress.

## The Fix: Save v1 Versioned
Implement the save v1 versioned concept in console output, then apply it to the running game in Part 2.

## Your Task
Complete the TODOs to produce the expected console output.

## Beginner Trap
**Storing the version number at the end of the file instead of the beginning.** If you read the version first, you can choose the correct deserialization logic before reading any data. Version at the end is useless — you have already read everything.

## Elite Insight
PNG, ZIP, and SQLite all store a magic number and version in the first few bytes. File format design always puts identification first. Your versioned save follows the same standard.

## Systems Thinking Connection
RPG (L24) and Crawler (L61) implement versioned saves the same way. Every path stores version first, then data. The serialization pattern is universal because the problem (forward compatibility) is universal.`,
    starterCode: `#include <iostream>
using namespace std;
struct SaveHeader { int version; int size; };
int main(){
    SaveHeader hdr;
    hdr.version = 1;
    hdr.size = 64;
    // TODO: print Save: version=1 size=64
    // TODO: print SaveWrite: OK checksum=0
    return 0;
}`,
...
int main(){
    ...
    hdr.version = 1;
    hdr.size = 64;
    cout<<"Save: version="<<hdr.version<<" size="<<hdr.size<<endl;
    cout<<"SaveWrite: OK checksum=0"<<endl;
    return 0;
}`,
    tests: [
      { id: "t1", description: "save-v1-versioned line 1", expectedOutput: "Save: version=1 size=64" },
      { id: "t2", description: "save-v1-versioned line 2", expectedOutput: "SaveWrite: OK checksum=0" },
    ],
    hints: [
  ...
  part2: {
    title: "Build: Save v1 Versioned",
    type: "game_builder",
    instructions: `# Build: Save v1 Versioned

Add save v1 versioned to the running game.

## Did It Work?
Console shows the new save v1 versioned output alongside all previous outputs. Canvas shows the game with the new infrastructure active.`,
    starterCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
void hudSystem(World& w){
    DrawText("** L61: Replay & Save **",SCREEN_W/2-180,8,18,GOLD);
...
int main(){
    ...
    tests: [
      { id: "g1", description: "save-v1-versioned line 1", expectedOutput: "Save: version=1 size=64" },
      { id: "g2", description: "save-v1-versioned line 2", expectedOutput: "SaveWrite: OK checksum=0" },
    ],
    hints: [
