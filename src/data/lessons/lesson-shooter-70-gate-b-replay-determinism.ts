...
export const lessonShooter70: Lesson = {
  id: "shooter-70-gate-b-replay-determinism",
  title: "GATE B: Replay Determinism",
  description: "Identical signatures prove the simulation is deterministic.",
  order: 70,
  xpReward: 300,
  tier: "pro",
  concepts: ["GATE B", "replay determinism", "determinism gate", "simulation proof"],
  part1: {
...
## Mental Model
GATE B certifies replay determinism. Same inputs, same initial seed, same state at every frame. This is the foundation of multiplayer netcode, automated testing, and bug reproduction.

## What Breaks Without This
Without GATE B, replay is unproven. Multiplayer netcode, automated testing, and save integrity all depend on determinism.

## The Fix: GATE B: Replay Determinism
Implement the gate b: replay determinism concept in console output, then apply it to the running game in Part 2.

## Your Task
Complete the TODOs to produce the expected console output.

## Beginner Trap
**Passing the gate with a short replay.** A 10-second replay might pass when a 5-minute replay fails. Long sessions expose subtle drift from floating-point accumulation or uninitialized memory. Test with extended gameplay.

## Elite Insight
Lockstep determinism is proven by extended testing under varied conditions. Professional studios run overnight replay suites to build confidence. Your gate requires the same evidence: multiple long replays, zero divergence.

## Systems Thinking Connection
RPG L70, Crawler L70, and Platformer L70 all hit the same gate. Replay determinism is the most engineering-intensive gate in the curriculum — all four paths must prove bit-perfect reproducibility.`,
    starterCode: `#include <iostream>
using namespace std;
int main(){
    cout<<"GATE B: Replay Determinism"<<endl;
    // TODO: print all gate B inventory, then GATE B: PASSED
    return 0;
}`,
...
int main(){
    ...
    tests: [
      { id: "t1", description: "gate-b-replay-determinism line 1", expectedOutput: "GATE B: Replay Determinism" },
      { id: "t2", description: "gate-b-replay-determinism line 2", expectedOutput: "GATE B: PASSED" },
    ],
    hints: [
...
Add gate b: replay determinism to the running game.

## Did It Work?
Console shows the new gate b: replay determinism output alongside all previous outputs. Canvas shows the game with the new infrastructure active.`,
    starterCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
void hudSystem(World& w){
    DrawText("** GATE B: REPLAY DETERMINISM **",SCREEN_W/2-180,8,18,GOLD);
...
int main(){
    ...
    tests: [
      { id: "g1", description: "gate-b-replay-determinism line 1", expectedOutput: "GATE B: Replay Determinism" },
      { id: "g2", description: "gate-b-replay-determinism line 2", expectedOutput: "GATE B: PASSED" },
      { id: "g3", description: "gate B header", expectedOutput: "GATE B: Replay Determinism" },
      { id: "g4", description: "gate B passes", expectedOutput: "GATE B: PASSED" },
      { id: "g5", description: "gate B pattern", expectedOutput: "Pattern: replay-determinism" },
    ],
    hints: [
