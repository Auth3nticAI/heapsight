...
export const lessonShooter71: Lesson = {
  id: "shooter-71-profiling-timers",
  title: "Profiling Timers",
  description: "Per-system ms printed in console.",
  order: 71,
  xpReward: 100,
  tier: "pro",
  concepts: ["profiling", "timing", "performance measurement"],
  part1: {
...
## Mental Model
Performance is not about guessing. It is about measuring. Per-system ms printed in console.

## What Breaks Without This
Without profiling, you optimize the wrong system. Measure first.

## The Fix: Profiling Timers
Implement the profiling timers concept in console output, then apply it to the running game in Part 2.
...
## Elite Insight
Carmack profiled Doom and Quake with custom timing macros — measuring each system pass independently. Modern tools (Tracy, Optick) automate this, but the principle is the same: measure before optimizing.

## Systems Thinking Connection
RPG L71, Crawler L51, and Platformer L71 all add profiling timers. Measurement is the first step of optimization in every path — you cannot improve what you have not measured.`,
    starterCode: `#include <iostream>
using namespace std;
int main(){
    cout<<"Profiling Timers"<<endl;
    // TODO: print all profiling timers diagnostics
    return 0;
}`,
...
int main(){
    ...
    tests: [
      { id: "t1", description: "profiling-timers line 1", expectedOutput: "Profiling Timers", isPattern: false },
      { id: "t2", description: "profiling-timers line 2", expectedOutput: "TotalFrame: 0.19ms", isPattern: false },
    ],
    hints: [
...
Add profiling timers to the running game.

## Did It Work?
Console shows the new profiling timers output alongside all previous outputs. Canvas shows the game with the new infrastructure active.`,
    starterCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
// TODO: Add profiling timers — see instructions`,
    solutionCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
void hudSystem(World& w){
    DrawText("** PROFILING TIMERS **",SCREEN_W/2-180,8,18,GOLD);
    DrawText(TextFormat("Score: %d x%d",w.score,1+w.combo_hits/10),10,38,18,WHITE);
    DrawText(TextFormat("Wave:  %d",w.wave),10,62,18,WHITE);
    DrawText(TextFormat("HP: %d/%d",w.player_hp,w.player_max_hp),10,86,18,WHITE);
    DrawText(TextFormat("Lives: %d",w.lives),10,110,18,PINK);
...
int main(){
    ...
    tests: [
      { id: "g1", description: "profiling-timers line 1", expectedOutput: "Profiling Timers", isPattern: false },
      { id: "g2", description: "profiling-timers output", expectedOutput: "SysTime: input=0.01 move=0.02 collide=0.05 ai=0.01 wave=0.00 render=0.10", isPattern: false },
      { id: "g3", description: "profiling-timers complete", expectedOutput: "TotalFrame: 0.19ms", isPattern: false },
