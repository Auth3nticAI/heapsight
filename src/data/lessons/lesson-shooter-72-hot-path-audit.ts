...
export const lessonShooter72: Lesson = {
  id: "shooter-72-hot-path-audit",
  title: "Hot Path Audit",
  description: "Fewer branches in movement/collision.",
  order: 72,
  xpReward: 100,
  tier: "pro",
  concepts: ["hot path", "branch elimination", "optimization"],
  part1: {
...
## Mental Model
Performance is not about guessing. It is about measuring. Fewer branches in movement/collision.

## What Breaks Without This
Branches in inner loops cause pipeline stalls. The CPU predicts wrong, flushes, starts over.

## The Fix: Hot Path Audit
Implement the hot path audit concept in console output, then apply it to the running game in Part 2.

## Your Task
Complete the TODOs to produce the expected console output.

## Beginner Trap
**Optimizing a function that takes 0.1ms when another takes 4ms.** The hot path is the code that consumes the most frame time. Optimize the biggest bottleneck first. Profiling data tells you what to fix.

## Elite Insight
The Pareto principle applies to optimization: 20% of the code consumes 80% of the frame time. Audit the hot path — the inner loops of collision, movement, and rendering — and leave cold code alone.

## Systems Thinking Connection
RPG (L72) and Platformer (L72) audit their hot paths too. Every path converges on the same optimization discipline: profile, identify the bottleneck, optimize it, re-profile to verify the improvement.`,
    starterCode: `#include <iostream>
using namespace std;
int main(){
    cout<<"Hot Path Audit"<<endl;
    // TODO: print all hot path audit diagnostics
    return 0;
}`,
...
int main(){
    ...
    tests: [
      { id: "t1", description: "hot-path-audit line 1", expectedOutput: "Hot Path Audit", isPattern: false },
      { id: "t2", description: "hot-path-audit line 2", expectedOutput: "OptLevel: clean", isPattern: false },
    ],
    hints: [
...
Add hot path audit to the running game.

## Did It Work?
Console shows the new hot path audit output alongside all previous outputs. Canvas shows the game with the new infrastructure active.`,
    starterCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
// TODO: Add hot path audit — see instructions`,
    solutionCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
int main(){
    ...
    tests: [
      { id: "g1", description: "hot-path-audit line 1", expectedOutput: "Hot Path Audit", isPattern: false },
      { id: "g2", description: "hot-path-audit output", expectedOutput: "HotPath: movement branchless", isPattern: false },
      { id: "g3", description: "hot-path-audit complete", expectedOutput: "OptLevel: clean", isPattern: false },
