...
export const lessonShooter74: Lesson = {
  id: "shooter-74-pool-stats",
  title: "Pool Stats",
  description: "Peak pool usage printed.",
  order: 74,
  xpReward: 100,
  tier: "pro",
  concepts: ["pool stats", "peak usage", "resource monitoring"],
  part1: {
...
## Mental Model
Performance is not about guessing. It is about measuring. Peak pool usage printed.

## What Breaks Without This
Without peak stats, you do not know if pools are sized right. Oversized wastes memory, undersized drops spawns.

## The Fix: Pool Stats
Implement the pool stats concept in console output, then apply it to the running game in Part 2.

## Your Task
Complete the TODOs to produce the expected console output.

## Beginner Trap
**Setting pool capacity based on average usage instead of peak usage.** Pools must handle the worst case, not the average case. Track peak_used across the entire session and size the pool to peak + margin.

## Elite Insight
Memory pool monitoring is standard in professional engines. Unity profiler shows pool utilization. Unreal tracks peak object counts. Your pool stats dashboard is the manual equivalent of the same diagnostic.

## Systems Thinking Connection
RPG (L74) and Crawler audit pool utilization. Platformer (L74) does too. Pool sizing is a universal optimization task — too small causes overflow, too large wastes memory. Peak tracking guides the right size.`,
    starterCode: `#include <iostream>
using namespace std;
int main(){
    cout<<"Pool Stats"<<endl;
    // TODO: print all pool stats diagnostics
    return 0;
}`,
...
int main(){
    ...
    tests: [
      { id: "t1", description: "pool-stats line 1", expectedOutput: "Pool Stats", isPattern: false },
      { id: "t2", description: "pool-stats line 2", expectedOutput: "PoolEfficiency: 23/48=47%", isPattern: false },
    ],
    hints: [
...
Add pool stats to the running game.

## Did It Work?
Console shows the new pool stats output alongside all previous outputs. Canvas shows the game with the new infrastructure active.`,
    starterCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
// TODO: Add pool stats — see instructions`,
    solutionCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
int main(){
    ...
    tests: [
      { id: "g1", description: "pool-stats line 1", expectedOutput: "Pool Stats", isPattern: false },
      { id: "g2", description: "pool-stats output", expectedOutput: "PeakEnemies: 5/5", isPattern: false },
      { id: "g3", description: "pool-stats complete", expectedOutput: "PoolEfficiency: 23/48=47%", isPattern: false },
