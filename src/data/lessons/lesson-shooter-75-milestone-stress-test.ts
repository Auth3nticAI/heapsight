...
export const lessonShooter75: Lesson = {
  id: "shooter-75-milestone-stress-test",
  title: "Milestone: Stress Test",
  description: "1000 entities, no frame drop.",
  order: 75,
  xpReward: 300,
  tier: "pro",
  concepts: ["stress test", "scale proof", "performance gate"],
  part1: {
...
## Mental Model
Performance is not about guessing. It is about measuring. 1000 entities, no frame drop.

## What Breaks Without This
Without a stress test, you ship a game that dies at 100 enemies.

## The Fix: Milestone: Stress Test
Implement the milestone stress test concept in console output, then apply it to the running game in Part 2.

## Your Task
Complete the TODOs to produce the expected console output.

## Beginner Trap
**Stress testing with the same number of entities as normal gameplay.** The point is to find the breaking point. Spawn 200+ bullets, 50+ enemies, and 10+ powerups simultaneously. If frame rate stays above 60fps, the architecture scales.
...
RPG (L75) stress tests with 50 entities. Crawler (L55) tests render optimization. Every path proves performance at scale — the entity count differs, but the principle is identical: verify the architecture handles peak load.`,
    starterCode: `#include <iostream>
using namespace std;
int main(){
    cout<<"Milestone: Stress Test"<<endl;
    // TODO: print all milestone stress test diagnostics
    return 0;
}`,
...
int main(){
    ...
    tests: [
      { id: "t1", description: "milestone-stress-test line 1", expectedOutput: "Milestone: Stress Test", isPattern: false },
      { id: "t2", description: "milestone-stress-test line 2", expectedOutput: "Milestone: StressTest", isPattern: false },
    ],
    hints: [
...
Add milestone stress test to the running game.

## Did It Work?
Console shows the new milestone stress test output alongside all previous outputs. Canvas shows the game with the new infrastructure active.`,
    starterCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
void hudSystem(World& w){
    DrawText("** POOL STATS **",SCREEN_W/2-180,8,18,GOLD);
...
// TODO: Add milestone stress test — see instructions`,
    solutionCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
void hudSystem(World& w){
    DrawText("** MILESTONE: STRESS TEST **",SCREEN_W/2-180,8,18,GOLD);
    DrawText(TextFormat("Score: %d x%d",w.score,1+w.combo_hits/10),10,38,18,WHITE);
    DrawText(TextFormat("Wave:  %d",w.wave),10,62,18,WHITE);
    DrawText(TextFormat("HP: %d/%d",w.player_hp,w.player_max_hp),10,86,18,WHITE);
    DrawText(TextFormat("Lives: %d",w.lives),10,110,18,PINK);
...
int main(){
    ...
    tests: [
      { id: "g1", description: "milestone-stress-test line 1", expectedOutput: "Milestone: Stress Test", isPattern: false },
      { id: "g2", description: "milestone-stress-test output", expectedOutput: "StressTest: 1000 entities", isPattern: false },
      { id: "g3", description: "milestone-stress-test complete", expectedOutput: "Milestone: StressTest", isPattern: false },
