...
export const lessonShooter77: Lesson = {
  id: "shooter-77-batch-rendering",
  title: "Batch Rendering",
  description: "Draw call batching.",
  order: 77,
  xpReward: 100,
  tier: "pro",
  concepts: ["batch rendering", "draw calls", "render performance"],
  part1: {
    title: "Concept: Batch Rendering",
    type: "concept",
    instructions: `# Batch Rendering

## Mental Model
Performance is not about guessing. It is about measuring. Draw call batching.

## What Breaks Without This
Individual draw calls per entity create GPU pipeline stalls. Batch to minimize state changes.

## The Fix: Batch Rendering
Implement the batch rendering concept in console output, then apply it to the running game in Part 2.

## Your Task
Complete the TODOs to produce the expected console output.

## Beginner Trap
**Calling DrawRectangle once per entity instead of batching.** Each draw call has CPU overhead. Sorting entities by color and drawing all same-colored entities in one batch reduces draw call count dramatically.

## Elite Insight
Sprite batching is the #1 2D rendering optimization. Unity SpriteRenderer batches by material. Your sort-by-color-then-draw approach is the software equivalent — minimize state changes between draw calls.

## Systems Thinking Connection
RPG could batch tile rendering. Crawler batches 3D cube draws. Platformer could batch sprites. Draw call reduction through batching is a universal rendering optimization — fewer state changes means faster rendering.`,
    starterCode: `#include <iostream>
using namespace std;
int main(){
    cout<<"Batch Rendering"<<endl;
    // TODO: print all batch rendering diagnostics
    return 0;
}`,
...
int main(){
    ...
    tests: [
      { id: "t1", description: "batch-rendering line 1", expectedOutput: "Batch Rendering", isPattern: false },
      { id: "t2", description: "batch-rendering line 2", expectedOutput: "RenderPass: 3 batches", isPattern: false },
    ],
    hints: [
  ...
  part2: {
    title: "Build: Batch Rendering",
    type: "game_builder",
    instructions: `# Build: Batch Rendering

Add batch rendering to the running game.

## Did It Work?
Console shows the new batch rendering output alongside all previous outputs. Canvas shows the game with the new infrastructure active.`,
    starterCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
// TODO: Add batch rendering — see instructions`,
    solutionCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
int main(){
    ...
    tests: [
      { id: "g1", description: "batch-rendering line 1", expectedOutput: "Batch Rendering", isPattern: false },
      { id: "g2", description: "batch-rendering output", expectedOutput: "DrawCalls: enemies=1 bullets=1 particles=1", isPattern: false },
      { id: "g3", description: "batch-rendering complete", expectedOutput: "RenderPass: 3 batches", isPattern: false },
