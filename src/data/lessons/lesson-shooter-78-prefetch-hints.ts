...
export const lessonShooter78: Lesson = {
  id: "shooter-78-prefetch-hints",
  title: "Prefetch Hints",
  description: "Cache-line documentation in code.",
  order: 78,
  xpReward: 100,
  tier: "pro",
  concepts: ["prefetch", "cache lines", "memory access"],
  part1: {
    title: "Concept: Prefetch Hints",
    type: "concept",
    instructions: `# Prefetch Hints

## Mental Model
Performance is not about guessing. It is about measuring. Cache-line documentation in code.

## What Breaks Without This
The CPU fetches cache lines reactively. Prefetch hints tell it what you need next.

## The Fix: Prefetch Hints
Implement the prefetch hints concept in console output, then apply it to the running game in Part 2.

## Your Task
Complete the TODOs to produce the expected console output.

## Beginner Trap
**Prefetching data that is already in cache.** Prefetch only helps for data that will be accessed several iterations later. Prefetch entity[i+4] while processing entity[i] — far enough ahead to hide memory latency.

## Elite Insight
Cache prefetch hints (__builtin_prefetch on GCC, _mm_prefetch on MSVC) tell the CPU to load data before it is needed. Professional game engines use prefetch in tight entity loops to hide memory access latency.

## Systems Thinking Connection
RPG and Crawler entity counts are too small for prefetch to help. Platformer might benefit in tile rendering. Your prefetch optimization is the most CPU-architecture-aware technique across all four paths.`,
    starterCode: `#include <iostream>
using namespace std;
int main(){
    cout<<"Prefetch Hints"<<endl;
    // TODO: print all prefetch hints diagnostics
    return 0;
}`,
...
int main(){
    ...
    tests: [
      { id: "t1", description: "prefetch-hints line 1", expectedOutput: "Prefetch Hints", isPattern: false },
      { id: "t2", description: "prefetch-hints line 2", expectedOutput: "HotData: position+velocity contiguous", isPattern: false },
    ],
    hints: [
  ...
  part2: {
    title: "Build: Prefetch Hints",
    type: "game_builder",
    instructions: `# Build: Prefetch Hints

Add prefetch hints to the running game.

## Did It Work?
Console shows the new prefetch hints output alongside all previous outputs. Canvas shows the game with the new infrastructure active.`,
    starterCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
void hudSystem(World& w){
    DrawText("** BATCH RENDERING **",SCREEN_W/2-180,8,18,GOLD);
...
// TODO: Add prefetch hints — see instructions`,
    solutionCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
int main(){
    ...
    tests: [
      { id: "g1", description: "prefetch-hints line 1", expectedOutput: "Prefetch Hints", isPattern: false },
      { id: "g2", description: "prefetch-hints output", expectedOutput: "CacheLine: 64 bytes=16 floats", isPattern: false },
      { id: "g3", description: "prefetch-hints complete", expectedOutput: "HotData: position+velocity contiguous", isPattern: false },
