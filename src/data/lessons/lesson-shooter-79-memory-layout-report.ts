...
export const lessonShooter79: Lesson = {
  id: "shooter-79-memory-layout-report",
  title: "Memory Layout Report",
  description: "sizeof + offsetof audit printed.",
  order: 79,
  xpReward: 100,
  tier: "pro",
  concepts: ["sizeof", "offsetof", "memory layout", "audit"],
  part1: {
    title: "Concept: Memory Layout Report",
    type: "concept",
    instructions: `# Memory Layout Report

## Mental Model
Performance is not about guessing. It is about measuring. sizeof + offsetof audit printed.

## What Breaks Without This
Without a memory audit, struct padding wastes bytes and cache lines.

## The Fix: Memory Layout Report
Implement the memory layout report concept in console output, then apply it to the running game in Part 2.

## Your Task
Complete the TODOs to produce the expected console output.

## Beginner Trap
**Assuming sizeof(struct) equals the sum of field sizes.** Compilers add padding for alignment. sizeof(struct { char a; int b; }) is often 8, not 5. Use offsetof to verify actual field positions and find wasted padding bytes.

## Elite Insight
Reordering struct fields to minimize padding is a standard optimization. Sort fields by size (largest first) to reduce wasted bytes. Professional engines audit struct layouts to ensure cache-line-friendly data.

## Systems Thinking Connection
RPG and Crawler use simpler structs. Platformer does not audit memory layout. Your sizeof/offsetof report is a unique systems-level diagnostic that directly connects to CPU cache architecture.`,
    starterCode: `#include <iostream>
using namespace std;
int main(){
    cout<<"Memory Layout Report"<<endl;
    // TODO: print all memory layout report diagnostics
    return 0;
}`,
...
int main(){
    ...
    tests: [
      { id: "t1", description: "memory-layout-report line 1", expectedOutput: "Memory Layout Report", isPattern: false },
      { id: "t2", description: "memory-layout-report line 2", expectedOutput: "MemoryAudit: layout clean", isPattern: false },
    ],
    hints: [
  ...
  part2: {
    title: "Build: Memory Layout Report",
    type: "game_builder",
    instructions: `# Build: Memory Layout Report

Add memory layout report to the running game.

## Did It Work?
Console shows the new memory layout report output alongside all previous outputs. Canvas shows the game with the new infrastructure active.`,
    starterCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
void hudSystem(World& w){
    DrawText("** PREFETCH HINTS **",SCREEN_W/2-180,8,18,GOLD);
...
// TODO: Add memory layout report — see instructions`,
    solutionCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
int main(){
    ...
    tests: [
      { id: "g1", description: "memory-layout-report line 1", expectedOutput: "Memory Layout Report", isPattern: false },
      { id: "g2", description: "memory-layout-report output", expectedOutput: "sizeof(World): large", isPattern: false },
      { id: "g3", description: "memory-layout-report complete", expectedOutput: "MemoryAudit: layout clean", isPattern: false },
