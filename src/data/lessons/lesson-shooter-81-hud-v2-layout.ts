...
export const lessonShooter81: Lesson = {
  id: "shooter-81-hud-v2-layout",
  title: "HUD v2 Layout",
  description: "Clean score/lives/wave display.",
  order: 81,
  xpReward: 100,
  tier: "pro",
  concepts: ["HUD", "information architecture", "UI layout"],
  part1: {
...
## Mental Model
Polish transforms a functional game into a felt experience. Clean score/lives/wave display.

## What Breaks Without This
A cluttered HUD overwhelms the player. Information architecture matters.

## The Fix: HUD v2 Layout
Implement the hud v2 layout concept in console output, then apply it to the running game in Part 2.

## Your Task
Complete the TODOs to produce the expected console output.

## Beginner Trap
**Using absolute pixel positions for HUD elements.** If the window resizes, all positions break. Use anchor-relative positions: "10px from top-left" adapts to any resolution. Anchor + offset is the professional UI pattern.

## Elite Insight
Every professional game engine uses anchor-based UI layout. Unity Canvas, Unreal UMG, and Godot Control nodes all position elements relative to screen edges or parent containers, never absolute pixels.

## Systems Thinking Connection
RPG (L81) and Platformer (L81) implement the same anchor-based HUD. The Crawler overlays 3D HUD elements. HUD architecture is identical across all paths — only the displayed information differs by genre.`,
    starterCode: `#include <iostream>
using namespace std;
int main(){
    cout<<"HUD v2 Layout"<<endl;
    // TODO: print all hud v2 layout diagnostics
    return 0;
}`,
...
int main(){
    ...
    tests: [
      { id: "t1", description: "hud-v2-layout line 1", expectedOutput: "HUD v2 Layout", isPattern: false },
      { id: "t2", description: "hud-v2-layout line 2", expectedOutput: "InfoArch: clean layout", isPattern: false },
    ],
    hints: [
...
Add hud v2 layout to the running game.

## Did It Work?
Console shows the new hud v2 layout output alongside all previous outputs. Canvas shows the game with the new infrastructure active.`,
    starterCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
// TODO: Add hud v2 layout — see instructions`,
    solutionCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
int main(){
    ...
    tests: [
      { id: "g1", description: "hud-v2-layout line 1", expectedOutput: "HUD v2 Layout", isPattern: false },
      { id: "g2", description: "hud-v2-layout output", expectedOutput: "HUDv2: score+wave+hp+lives+flags+shield", isPattern: false },
      { id: "g3", description: "hud-v2-layout complete", expectedOutput: "InfoArch: clean layout", isPattern: false },
