...
export const lessonShooter82: Lesson = {
  id: "shooter-82-screen-shake-v0",
  title: "Screen Shake v0",
  description: "Shake on player hit.",
  order: 82,
  xpReward: 100,
  tier: "pro",
  concepts: ["screen shake", "offset feedback", "juice"],
  part1: {
    title: "Concept: Screen Shake v0",
    type: "concept",
    instructions: `# Screen Shake v0

## Mental Model
Polish transforms a functional game into a felt experience. Shake on player hit.

## What Breaks Without This
A hit without feedback feels broken. Screen shake tells the player something happened.

## The Fix: Screen Shake v0
Implement the screen shake v0 concept in console output, then apply it to the running game in Part 2.

## Your Task
Complete the TODOs to produce the expected console output.

## Beginner Trap
**Applying screen shake by moving entity positions instead of offsetting the camera.** Moving entities permanently displaces them. Shake should be a temporary render-time offset applied to the camera or the draw position, never to the game state.

## Elite Insight
Vlambeer (Nuclear Throne) popularized screen shake as a "game feel" essential. A 3-frame, 4-pixel shake on enemy death makes the game feel impactful. The effect is pure presentation — no game state is modified.

## Systems Thinking Connection
RPG (L82) adds combat feedback. Platformer (L82) adds screen shake. Crawler could add first-person camera shake. Screen shake is the simplest high-impact juice effect — render-only, zero gameplay side effects.`,
    starterCode: `#include <iostream>
using namespace std;
int main(){
    cout<<"Screen Shake v0"<<endl;
    // TODO: print all screen shake v0 diagnostics
    return 0;
}`,
...
int main(){
    ...
    tests: [
      { id: "t1", description: "screen-shake-v0 line 1", expectedOutput: "Screen Shake v0", isPattern: false },
      { id: "t2", description: "screen-shake-v0 line 2", expectedOutput: "ShakeDet: seeded pattern", isPattern: false },
    ],
    hints: [
  ...
  part2: {
    title: "Build: Screen Shake v0",
    type: "game_builder",
    instructions: `# Build: Screen Shake v0

Add screen shake v0 to the running game.

## Did It Work?
Console shows the new screen shake v0 output alongside all previous outputs. Canvas shows the game with the new infrastructure active.`,
    starterCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
void hudSystem(World& w){
    DrawText("** HUD V2 LAYOUT **",SCREEN_W/2-180,8,18,GOLD);
...
// TODO: Add screen shake v0 — see instructions`,
    solutionCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
void hudSystem(World& w){
    DrawText("** SCREEN SHAKE V0 **",SCREEN_W/2-180,8,18,GOLD);
    DrawText(TextFormat("Score: %d x%d",w.score,1+w.combo_hits/10),10,38,18,WHITE);
    DrawText(TextFormat("Wave:  %d",w.wave),10,62,18,WHITE);
    DrawText(TextFormat("HP: %d/%d",w.player_hp,w.player_max_hp),10,86,18,WHITE);
    DrawText(TextFormat("Lives: %d",w.lives),10,110,18,PINK);
...
int main(){
    ...
    tests: [
      { id: "g1", description: "screen-shake-v0 line 1", expectedOutput: "Screen Shake v0", isPattern: false },
      { id: "g2", description: "screen-shake-v0 output", expectedOutput: "Shake: offset=(3,-2) dur=10", isPattern: false },
      { id: "g3", description: "screen-shake-v0 complete", expectedOutput: "ShakeDet: seeded pattern", isPattern: false },
