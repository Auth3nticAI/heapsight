...
export const lessonShooter83: Lesson = {
  id: "shooter-83-particle-burst",
  title: "Particle Burst",
  description: "Explosion on enemy kill.",
  order: 83,
  xpReward: 100,
  tier: "pro",
  concepts: ["particle burst", "pooled particles", "visual feedback"],
  part1: {
    title: "Concept: Particle Burst",
    type: "concept",
    instructions: `# Particle Burst

## Mental Model
Polish transforms a functional game into a felt experience. Explosion on enemy kill.

## What Breaks Without This
Enemies vanish silently without particle bursts. Visual feedback sells the impact.

## The Fix: Particle Burst
Implement the particle burst concept in console output, then apply it to the running game in Part 2.

## Your Task
Complete the TODOs to produce the expected console output.

## Beginner Trap
**Allocating particles with new/malloc.** Particles spawn in bursts (10-50 at once) and die quickly. Use a fixed-size particle pool. Pre-allocate 256 particles and cycle through them. Zero allocation, maximum visual impact.

## Elite Insight
Every particle system in professional engines uses pool allocation. Particles are the most allocation-intensive system in any game. Pool-based particles maintain the heap-freeze guarantee under heavy visual effects.

## Systems Thinking Connection
RPG uses sprite animation for feedback. Platformer (L83) adds particle effects. Crawler (L58) implements a full particle system. Pool-based particles are universal — the visual effect varies, the allocation pattern is identical.`,
    starterCode: `#include <iostream>
using namespace std;
int main(){
    cout<<"Particle Burst"<<endl;
    // TODO: print all particle burst diagnostics
    return 0;
}`,
...
int main(){
    ...
    tests: [
      { id: "t1", description: "particle-burst line 1", expectedOutput: "Particle Burst", isPattern: false },
      { id: "t2", description: "particle-burst line 2", expectedOutput: "VisualFeedback: pooled bursts", isPattern: false },
    ],
    hints: [
  ...
  part2: {
    title: "Build: Particle Burst",
    type: "game_builder",
    instructions: `# Build: Particle Burst

Add particle burst to the running game.

## Did It Work?
Console shows the new particle burst output alongside all previous outputs. Canvas shows the game with the new infrastructure active.`,
    starterCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
// TODO: Add particle burst — see instructions`,
    solutionCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
int main(){
    ...
    tests: [
      { id: "g1", description: "particle-burst line 1", expectedOutput: "Particle Burst", isPattern: false },
      { id: "g2", description: "particle-burst output", expectedOutput: "ParticleBurst: 5 per kill", isPattern: false },
      { id: "g3", description: "particle-burst complete", expectedOutput: "VisualFeedback: pooled bursts", isPattern: false },
