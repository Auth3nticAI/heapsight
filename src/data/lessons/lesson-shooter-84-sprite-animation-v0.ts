...
export const lessonShooter84: Lesson = {
  id: "shooter-84-sprite-animation-v0",
  title: "Sprite Animation v0",
  description: "Frame toggle for entities.",
  order: 84,
  xpReward: 100,
  tier: "pro",
  concepts: ["sprite animation", "timer cycling", "frame toggle"],
  part1: {
...
## Mental Model
Polish transforms a functional game into a felt experience. Frame toggle for entities.

## What Breaks Without This
Static sprites feel lifeless. Even a 2-frame toggle adds perceived life.

## The Fix: Sprite Animation v0
Implement the sprite animation v0 concept in console output, then apply it to the running game in Part 2.

## Your Task
Complete the TODOs to produce the expected console output.

## Beginner Trap
**Advancing animation frames using a frame counter instead of delta time.** On a 120fps monitor, animations play twice as fast. Use a time accumulator: add dt, advance frame when accumulator > frame_duration.

## Elite Insight
Sprite animation with time accumulators is the industry standard — frame rate independent, tunable frame durations, and trivial to implement. Every 2D engine uses this approach internally.

## Systems Thinking Connection
RPG (L83) and Platformer (L84) implement the same delta-time animation. The Crawler uses 3D model animation. Frame-rate-independent animation is mandatory across all paths — the technique is universal.`,
    starterCode: `#include <iostream>
using namespace std;
int main(){
    cout<<"Sprite Animation v0"<<endl;
    // TODO: print all sprite animation v0 diagnostics
    return 0;
}`,
...
int main(){
    ...
    tests: [
      { id: "t1", description: "sprite-animation-v0 line 1", expectedOutput: "Sprite Animation v0", isPattern: false },
      { id: "t2", description: "sprite-animation-v0 line 2", expectedOutput: "SpriteAnim: 2-frame toggle", isPattern: false },
    ],
    hints: [
...
Add sprite animation v0 to the running game.

## Did It Work?
Console shows the new sprite animation v0 output alongside all previous outputs. Canvas shows the game with the new infrastructure active.`,
    starterCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
void hudSystem(World& w){
    DrawText("** PARTICLE BURST **",SCREEN_W/2-180,8,18,GOLD);
...
// TODO: Add sprite animation v0 — see instructions`,
    solutionCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
int main(){
    ...
    tests: [
      { id: "g1", description: "sprite-animation-v0 line 1", expectedOutput: "Sprite Animation v0", isPattern: false },
      { id: "g2", description: "sprite-animation-v0 output", expectedOutput: "AnimFrame: toggle every 15 ticks", isPattern: false },
      { id: "g3", description: "sprite-animation-v0 complete", expectedOutput: "SpriteAnim: 2-frame toggle", isPattern: false },
