...
export const lessonShooter85: Lesson = {
  id: "shooter-85-milestone-juiced-shooter",
  title: "Milestone: Juiced Shooter",
  description: "Particles, shake, animation feel polished.",
  order: 85,
  xpReward: 300,
  tier: "pro",
  concepts: ["juice", "polish", "visual feedback", "milestone"],
  part1: {
    title: "Concept: Milestone: Juiced Shooter",
    type: "concept",
    instructions: `# Milestone: Juiced Shooter

## Mental Model
Polish transforms a functional game into a felt experience. Particles, shake, animation feel polished.

## What Breaks Without This
Juice is not optional. Players judge games by feel, not architecture.

## The Fix: Milestone: Juiced Shooter
Implement the milestone juiced shooter concept in console output, then apply it to the running game in Part 2.

## Your Task
Complete the TODOs to produce the expected console output.

## Beginner Trap
**Adding juice without measuring frame impact.** Screen shake, particles, and animations all cost CPU time. Profile the render pass before and after juice effects. If effects drop the frame rate, simplify or cull distant effects.

## Elite Insight
Game feel ("juice") is the difference between a prototype and a product. Jan Willem Nijman (Vlambeer) lists screen shake, particles, hit flash, and sound as the minimum juice checklist. Your milestone tests all four.

## Systems Thinking Connection
RPG (L85), Platformer (L85), and Crawler (L60) all hit juice milestones. The effects differ by genre (2D particles vs 3D particles vs sprite flashes) but the principle is universal: feedback makes games feel alive.`,
    starterCode: `#include <iostream>
using namespace std;
int main(){
    cout<<"Milestone: Juiced Shooter"<<endl;
    // TODO: print all milestone juiced shooter diagnostics
    return 0;
}`,
...
int main(){
    ...
    tests: [
      { id: "t1", description: "milestone-juiced-shooter line 1", expectedOutput: "Milestone: Juiced Shooter", isPattern: false },
      { id: "t2", description: "milestone-juiced-shooter line 2", expectedOutput: "Pattern: juice-integration", isPattern: false },
    ],
    hints: [
  ...
  part2: {
    title: "Build: Milestone: Juiced Shooter",
    type: "game_builder",
    instructions: `# Build: Milestone: Juiced Shooter

Add milestone juiced shooter to the running game.

## Did It Work?
Console shows the new milestone juiced shooter output alongside all previous outputs. Canvas shows the game with the new infrastructure active.`,
    starterCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
void hudSystem(World& w){
    DrawText("** SPRITE ANIMATION V0 **",SCREEN_W/2-180,8,18,GOLD);
...
// TODO: Add milestone juiced shooter — see instructions`,
    solutionCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
void hudSystem(World& w){
    DrawText("** MILESTONE: JUICED SHOOTER **",SCREEN_W/2-180,8,18,GOLD);
    DrawText(TextFormat("Score: %d x%d",w.score,1+w.combo_hits/10),10,38,18,WHITE);
    DrawText(TextFormat("Wave:  %d",w.wave),10,62,18,WHITE);
    DrawText(TextFormat("HP: %d/%d",w.player_hp,w.player_max_hp),10,86,18,WHITE);
    DrawText(TextFormat("Lives: %d",w.lives),10,110,18,PINK);
...
int main(){
    ...
    tests: [
      { id: "g1", description: "milestone-juiced-shooter line 1", expectedOutput: "Milestone: Juiced Shooter", isPattern: false },
      { id: "g2", description: "milestone-juiced-shooter output", expectedOutput: "JuiceCheck: shake=active particles=active anim=active", isPattern: false },
      { id: "g3", description: "milestone-juiced-shooter complete", expectedOutput: "Pattern: juice-integration", isPattern: false },
