...
export const lessonShooter87: Lesson = {
  id: "shooter-87-assist-mode",
  title: "Assist Mode",
  description: "Reduced speed, more lives toggle.",
  order: 87,
  xpReward: 100,
  tier: "pro",
  concepts: ["assist mode", "accessibility", "inclusive design"],
  part1: {
...
## Mental Model
Polish transforms a functional game into a felt experience. Reduced speed, more lives toggle.

## What Breaks Without This
Without assist mode, players with different abilities cannot enjoy the game.

## The Fix: Assist Mode
Implement the assist mode concept in console output, then apply it to the running game in Part 2.

## Your Task
Complete the TODOs to produce the expected console output.

## Beginner Trap
**Making assist mode a single "easy" toggle.** Players need granular control: slower enemies, more lives, wider hit detection. Independent toggles respect player agency more than a binary easy/normal/hard selection.

## Elite Insight
Celeste pioneered granular assist mode: game speed, stamina, invincibility, and dash count as independent sliders. The key insight: accessibility is not one toggle but a set of dials players combine to fit their needs.

## Systems Thinking Connection
RPG (L86) and Platformer (L87) implement the same granular assist concept. Accessibility as a first-class feature — not an afterthought — is a universal game design principle across all paths.`,
    starterCode: `#include <iostream>
using namespace std;
int main(){
    cout<<"Assist Mode"<<endl;
    // TODO: print all assist mode diagnostics
    return 0;
}`,
...
int main(){
    ...
    tests: [
      { id: "t1", description: "assist-mode line 1", expectedOutput: "Assist Mode", isPattern: false },
      { id: "t2", description: "assist-mode line 2", expectedOutput: "AssistToggle: on", isPattern: false },
    ],
    hints: [
...
Add assist mode to the running game.

## Did It Work?
Console shows the new assist mode output alongside all previous outputs. Canvas shows the game with the new infrastructure active.`,
    starterCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
// TODO: Add assist mode — see instructions`,
    solutionCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
int main(){
    ...
    tests: [
      { id: "g1", description: "assist-mode line 1", expectedOutput: "Assist Mode", isPattern: false },
      { id: "g2", description: "assist-mode output", expectedOutput: "AssistMode: speed*0.5 lives=5", isPattern: false },
      { id: "g3", description: "assist-mode complete", expectedOutput: "AssistToggle: on", isPattern: false },
