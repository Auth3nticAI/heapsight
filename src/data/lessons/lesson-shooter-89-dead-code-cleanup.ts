...
export const lessonShooter89: Lesson = {
  id: "shooter-89-dead-code-cleanup",
  title: "Dead Code Cleanup",
  description: "Remove unused code paths.",
  order: 89,
  xpReward: 100,
  tier: "pro",
  concepts: ["dead code", "cleanup", "code hygiene"],
  part1: {
...
## Mental Model
Polish transforms a functional game into a felt experience. Remove unused code paths.

## What Breaks Without This
Dead code confuses maintainers and increases build time.

## The Fix: Dead Code Cleanup
Implement the dead code cleanup concept in console output, then apply it to the running game in Part 2.

## Your Task
Complete the TODOs to produce the expected console output.

## Beginner Trap
**Commenting out dead code instead of deleting it.** Version control (git) preserves history. Commented-out code confuses future readers who wonder if it should be uncommented. Delete it — git log will have it if you need it.

## Elite Insight
Martin Fowler: "Dead code is a liability, not an asset." Every line of commented-out code is a line a future developer must read, understand, and decide to keep or delete. Remove the decision burden.

## Systems Thinking Connection
RPG (L89) and Platformer (L89) perform the same cleanup. Code hygiene is universal: dead code, inconsistent naming, and copy-pasted logic are problems in every codebase regardless of genre.`,
    starterCode: `#include <iostream>
using namespace std;
int main(){
    cout<<"Dead Code Cleanup"<<endl;
    // TODO: print all dead code cleanup diagnostics
    return 0;
}`,
...
int main(){
    ...
    tests: [
      { id: "t1", description: "dead-code-cleanup line 1", expectedOutput: "Dead Code Cleanup", isPattern: false },
      { id: "t2", description: "dead-code-cleanup line 2", expectedOutput: "Hygiene: clean", isPattern: false },
    ],
    hints: [
...
Add dead code cleanup to the running game.

## Did It Work?
Console shows the new dead code cleanup output alongside all previous outputs. Canvas shows the game with the new infrastructure active.`,
    starterCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
// TODO: Add dead code cleanup — see instructions`,
    solutionCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
int main(){
    ...
    tests: [
      { id: "g1", description: "dead-code-cleanup line 1", expectedOutput: "Dead Code Cleanup", isPattern: false },
      { id: "g2", description: "dead-code-cleanup output", expectedOutput: "CodeAudit: 0 unused functions", isPattern: false },
      { id: "g3", description: "dead-code-cleanup complete", expectedOutput: "Hygiene: clean", isPattern: false },
