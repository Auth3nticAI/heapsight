...
export const lessonShooter90: Lesson = {
  id: "shooter-90-milestone-public-beta",
  title: "Milestone: Public Beta",
  description: "Stable 5-minute run, no crashes.",
  order: 90,
  xpReward: 300,
  tier: "pro",
  concepts: ["public beta", "stability", "milestone"],
  part1: {
...
## Mental Model
Polish transforms a functional game into a felt experience. Stable 5-minute run, no crashes.

## What Breaks Without This
Without a stability test, bugs hide until the worst moment.

## The Fix: Milestone: Public Beta
Implement the milestone public beta concept in console output, then apply it to the running game in Part 2.

## Your Task
Complete the TODOs to produce the expected console output.

## Beginner Trap
**Releasing a beta without a test suite.** Manual testing cannot catch regressions across 90 lessons of accumulated code. Automated tests (RNG, collision, pool, save/load) catch what humans miss.

## Elite Insight
Steam Early Access games ship with CI/CD pipelines that run automated test suites before each build reaches players. Your public beta milestone requires the same quality gate: tests pass, game does not crash.

## Systems Thinking Connection
RPG (L90), Platformer (L90), and Crawler all hit the same beta milestone. The criteria are identical: automated tests pass, no crashes in a 10-minute session, all systems functional. Genre is irrelevant to shipping quality.`,
    starterCode: `#include <iostream>
using namespace std;
int main(){
    cout<<"Milestone: Public Beta"<<endl;
    // TODO: print all milestone public beta diagnostics
    return 0;
}`,
...
int main(){
    ...
    tests: [
      { id: "t1", description: "milestone-public-beta line 1", expectedOutput: "Milestone: Public Beta", isPattern: false },
      { id: "t2", description: "milestone-public-beta line 2", expectedOutput: "Pattern: public-beta", isPattern: false },
    ],
    hints: [
...
Add milestone public beta to the running game.

## Did It Work?
Console shows the new milestone public beta output alongside all previous outputs. Canvas shows the game with the new infrastructure active.`,
    starterCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
void hudSystem(World& w){
    DrawText("** DEAD CODE CLEANUP **",SCREEN_W/2-180,8,18,GOLD);
...
// TODO: Add milestone public beta — see instructions`,
    solutionCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
int main(){
    ...
    tests: [
      { id: "g1", description: "milestone-public-beta line 1", expectedOutput: "Milestone: Public Beta", isPattern: false },
      { id: "g2", description: "milestone-public-beta output", expectedOutput: "BetaTest: 5-min stable", isPattern: false },
      { id: "g3", description: "milestone-public-beta complete", expectedOutput: "Pattern: public-beta", isPattern: false },
