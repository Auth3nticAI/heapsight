...
export const lessonShooter93: Lesson = {
  id: "shooter-93-tests-pools",
  title: "Unit Tests: Pools",
  description: "Alloc/free/reuse verified.",
  order: 93,
  xpReward: 200,
  tier: "pro",
  concepts: ["unit tests", "pools", "alloc/free"],
  part1: {
    title: "Concept: Unit Tests: Pools",
    type: "concept",
    instructions: `# Unit Tests: Pools

## Mental Model
Shipping is a discipline. Every professional project passes these checks. Alloc/free/reuse verified.

## What Breaks Without This
Without pool tests, alloc/free bugs lurk until the stress test.

## The Fix: Unit Tests: Pools
Implement the tests pools concept in console output, then apply it to the running game in Part 2.

## Your Task
Complete the TODOs to produce the expected console output.

## Beginner Trap
**Testing pool allocation without testing deallocation.** Allocate all slots, free them all, allocate again. If the second allocation fails, the free-list is broken. Always test the full alloc/free/reuse cycle.

## Elite Insight
Memory allocator testing follows the alloc/free/stress pattern: allocate to capacity, free in random order, verify all slots are reclaimable. Your pool test follows the same methodology used for malloc implementations.

## Systems Thinking Connection
RPG and Crawler pool tests follow the same pattern. Platformer (L27) tests particle pool reuse. Pool lifecycle testing is universal because pool bugs (leaks, double-free, use-after-free) exist in every pool implementation.`,
    starterCode: `#include <iostream>
using namespace std;
int main(){
    cout<<"Unit Tests: Pools"<<endl;
    // TODO: print all tests pools diagnostics
    return 0;
}`,
...
int main(){
    ...
    tests: [
      { id: "t1", description: "tests-pools line 1", expectedOutput: "Unit Tests: Pools", isPattern: false },
      { id: "t2", description: "tests-pools line 2", expectedOutput: "TestPool: PASS", isPattern: false },
    ],
    hints: [
  ...
  part2: {
    title: "Build: Unit Tests: Pools",
    type: "game_builder",
    instructions: `# Build: Unit Tests: Pools

Add tests pools to the running game.

## Did It Work?
Console shows the new tests pools output alongside all previous outputs. Canvas shows the game with the new infrastructure active.`,
    starterCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
void hudSystem(World& w){
    DrawText("** UNIT TESTS: RNG **",SCREEN_W/2-180,8,18,GOLD);
...
// TODO: Add tests pools — see instructions`,
    solutionCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
int main(){
    ...
    tests: [
      { id: "g1", description: "tests-pools line 1", expectedOutput: "Unit Tests: Pools", isPattern: false },
      { id: "g2", description: "tests-pools output", expectedOutput: "TestPool: alloc slot=0 OK", isPattern: false },
      { id: "g3", description: "tests-pools complete", expectedOutput: "TestPool: PASS", isPattern: false },
