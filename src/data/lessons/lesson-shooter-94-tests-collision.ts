...
export const lessonShooter94: Lesson = {
  id: "shooter-94-tests-collision",
  title: "Unit Tests: Collision",
  description: "AABB + grid verified.",
  order: 94,
  xpReward: 200,
  tier: "pro",
  concepts: ["unit tests", "collision", "AABB verification"],
  part1: {
...
## Mental Model
Shipping is a discipline. Every professional project passes these checks. AABB + grid verified.

## What Breaks Without This
Without collision tests, edge cases cause bullets to phase through enemies.

## The Fix: Unit Tests: Collision
Implement the tests collision concept in console output, then apply it to the running game in Part 2.

## Your Task
Complete the TODOs to produce the expected console output.

## Beginner Trap
**Testing collision with overlapping rectangles only.** You need to test: overlapping (true), separated (false), touching edges (boundary case), and zero-size (degenerate). Four test cases cover the behavior space.

## Elite Insight
Unit testing collision with known inputs and expected outputs is how physics engines verify correctness. Bullet Physics and Box2D both have extensive AABB test suites. Your four-case test follows the same methodology.

## Systems Thinking Connection
RPG tests combat formulas. Crawler tests spatial queries. Platformer (L93) tests grid collision. Every path tests its core collision/interaction system with deterministic inputs and expected outputs.`,
    starterCode: `#include <iostream>
using namespace std;
int main(){
    cout<<"Unit Tests: Collision"<<endl;
    // TODO: print all tests collision diagnostics
    return 0;
}`,
...
int main(){
    ...
    tests: [
      { id: "t1", description: "tests-collision line 1", expectedOutput: "Unit Tests: Collision", isPattern: false },
      { id: "t2", description: "tests-collision line 2", expectedOutput: "TestCollision: PASS", isPattern: false },
    ],
    hints: [
...
Add tests collision to the running game.

## Did It Work?
Console shows the new tests collision output alongside all previous outputs. Canvas shows the game with the new infrastructure active.`,
    starterCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
void hudSystem(World& w){
    DrawText("** UNIT TESTS: POOLS **",SCREEN_W/2-180,8,18,GOLD);
...
// TODO: Add tests collision — see instructions`,
    solutionCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
int main(){
    ...
    tests: [
      { id: "g1", description: "tests-collision line 1", expectedOutput: "Unit Tests: Collision", isPattern: false },
      { id: "g2", description: "tests-collision output", expectedOutput: "TestAABB: overlap=true OK", isPattern: false },
      { id: "g3", description: "tests-collision complete", expectedOutput: "TestCollision: PASS", isPattern: false },
