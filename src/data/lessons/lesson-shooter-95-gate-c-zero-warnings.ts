...
export const lessonShooter95: Lesson = {
  id: "shooter-95-gate-c-zero-warnings",
  title: "GATE C: Zero Warnings",
  description: "-Wall -Wextra -Werror clean build.",
  order: 95,
  xpReward: 300,
  tier: "pro",
  concepts: ["GATE C", "zero warnings", "compiler discipline"],
  part1: {
...
## Mental Model
Shipping is a discipline. Every professional project passes these checks. -Wall -Wextra -Werror clean build.

## What Breaks Without This
Warnings are bugs waiting to happen. -Werror makes the compiler your ally.

## The Fix: GATE C: Zero Warnings
Implement the gate c zero warnings concept in console output, then apply it to the running game in Part 2.
...
## Elite Insight
Google, Mozilla, and game studios compile with -Wall -Werror. Warnings are treated as errors because they frequently indicate real bugs: unused variables, sign conversion, implicit narrowing.

## Systems Thinking Connection
RPG (L95), Platformer (L95), and Crawler all hit the same zero-warnings gate. Clean compilation is the universal quality bar — every path must pass before shipping.`,
    starterCode: `#include <iostream>
using namespace std;
int main(){
    cout<<"GATE C: Zero Warnings"<<endl;
    // TODO: print all gate c zero warnings diagnostics
    return 0;
}`,
...
int main(){
    ...
    tests: [
      { id: "t1", description: "gate-c-zero-warnings line 1", expectedOutput: "GATE C: Zero Warnings", isPattern: false },
      { id: "t2", description: "gate-c-zero-warnings line 2", expectedOutput: "Pattern: zero-warnings", isPattern: false },
    ],
    hints: [
...
Add gate c zero warnings to the running game.

## Did It Work?
Console shows the new gate c zero warnings output alongside all previous outputs. Canvas shows the game with the new infrastructure active.`,
    starterCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
void hudSystem(World& w){
    DrawText("** UNIT TESTS: COLLISION **",SCREEN_W/2-180,8,18,GOLD);
...
// TODO: Add gate c zero warnings — see instructions`,
    solutionCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
int main(){
    ...
    tests: [
      { id: "g1", description: "gate-c-zero-warnings line 1", expectedOutput: "GATE C: Zero Warnings", isPattern: false },
      { id: "g2", description: "gate-c-zero-warnings output", expectedOutput: "GATE C: Zero Warnings", isPattern: false },
      { id: "g3", description: "gate-c-zero-warnings complete", expectedOutput: "Pattern: zero-warnings", isPattern: false },
