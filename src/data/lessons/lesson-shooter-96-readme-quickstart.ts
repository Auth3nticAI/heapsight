...
export const lessonShooter96: Lesson = {
  id: "shooter-96-readme-quickstart",
  title: "README Quickstart",
  description: "One-command build + run.",
  order: 96,
  xpReward: 200,
  tier: "pro",
  concepts: ["README", "documentation", "quickstart"],
  part1: {
...
## Mental Model
Shipping is a discipline. Every professional project passes these checks. One-command build + run.

## What Breaks Without This
Without a README, no one can build your project.

## The Fix: README Quickstart
Implement the readme quickstart concept in console output, then apply it to the running game in Part 2.
...
## Elite Insight
Open-source projects succeed or fail based on README quality. A "clone, build, run" sequence that works on the first try drives adoption. Your quickstart should get a new developer from zero to running game in under 5 minutes.

## Systems Thinking Connection
RPG (L96), Platformer (L96), and Crawler create READMEs. The structure is identical: project description, build instructions, controls, architecture overview. Documentation is a universal shipping requirement.`,
    starterCode: `#include <iostream>
using namespace std;
int main(){
    cout<<"README Quickstart"<<endl;
    // TODO: print all readme quickstart diagnostics
    return 0;
}`,
...
int main(){
    ...
    tests: [
      { id: "t1", description: "readme-quickstart line 1", expectedOutput: "README Quickstart", isPattern: false },
      { id: "t2", description: "readme-quickstart line 2", expectedOutput: "DocComplete: true", isPattern: false },
    ],
    hints: [
...
Add readme quickstart to the running game.

## Did It Work?
Console shows the new readme quickstart output alongside all previous outputs. Canvas shows the game with the new infrastructure active.`,
    starterCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
void hudSystem(World& w){
    DrawText("** GATE C: ZERO WARNINGS **",SCREEN_W/2-180,8,18,GOLD);
...
// TODO: Add readme quickstart — see instructions`,
    solutionCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
int main(){
    ...
    tests: [
      { id: "g1", description: "readme-quickstart line 1", expectedOutput: "README Quickstart", isPattern: false },
      { id: "g2", description: "readme-quickstart output", expectedOutput: "README: sections=4", isPattern: false },
      { id: "g3", description: "readme-quickstart complete", expectedOutput: "DocComplete: true", isPattern: false },
