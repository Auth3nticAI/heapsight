...
export const lessonShooter97: Lesson = {
  id: "shooter-97-screenshot-capture",
  title: "Screenshot Capture",
  description: "Screenshots in assets/screenshots/.",
  order: 97,
  xpReward: 200,
  tier: "pro",
  concepts: ["screenshots", "visual documentation", "assets"],
  part1: {
...
## Mental Model
Shipping is a discipline. Every professional project passes these checks. Screenshots in assets/screenshots/.

## What Breaks Without This
Without screenshots, recruiters scroll past your repo.

## The Fix: Screenshot Capture
Implement the screenshot capture concept in console output, then apply it to the running game in Part 2.

## Your Task
Complete the TODOs to produce the expected console output.

## Beginner Trap
**Capturing screenshots with debug overlays visible.** Profiling timers, collision boxes, and pool stats are developer tools. Portfolio screenshots should show clean gameplay. Disable debug rendering before capturing.

## Elite Insight
Steam store pages require specific screenshot formats and content quality. Screenshots are marketing assets — they represent the game to potential players. Clean, well-composed screenshots are a shipping requirement.

## Systems Thinking Connection
RPG (L97), Platformer (L97), and Crawler produce clean gameplay screenshots. Visual artifacts for portfolio presentation are a universal deliverable — the game and the screenshots ship together.`,
    starterCode: `#include <iostream>
using namespace std;
int main(){
    cout<<"Screenshot Capture"<<endl;
    // TODO: print all screenshot capture diagnostics
    return 0;
}`,
...
int main(){
    ...
    tests: [
      { id: "t1", description: "screenshot-capture line 1", expectedOutput: "Screenshot Capture", isPattern: false },
      { id: "t2", description: "screenshot-capture line 2", expectedOutput: "ScreenshotCount: 2", isPattern: false },
    ],
    hints: [
...
Add screenshot capture to the running game.

## Did It Work?
Console shows the new screenshot capture output alongside all previous outputs. Canvas shows the game with the new infrastructure active.`,
    starterCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
void hudSystem(World& w){
    DrawText("** README QUICKSTART **",SCREEN_W/2-180,8,18,GOLD);
...
// TODO: Add screenshot capture — see instructions`,
    solutionCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
int main(){
    ...
    tests: [
      { id: "g1", description: "screenshot-capture line 1", expectedOutput: "Screenshot Capture", isPattern: false },
      { id: "g2", description: "screenshot-capture output", expectedOutput: "Screenshot: gameplay.png 800x450", isPattern: false },
      { id: "g3", description: "screenshot-capture complete", expectedOutput: "ScreenshotCount: 2", isPattern: false },
