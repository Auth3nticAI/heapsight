...
export const lessonShooter98: Lesson = {
  id: "shooter-98-final-content-pass",
  title: "Final Content Pass",
  description: "10+ waves, 5+ enemy types, boss.",
  order: 98,
  xpReward: 200,
  tier: "pro",
  concepts: ["content pass", "completeness", "quality audit"],
  part1: {
...
## Mental Model
Shipping is a discipline. Every professional project passes these checks. 10+ waves, 5+ enemy types, boss.

## What Breaks Without This
Without enough content, the game ends before the player is hooked.

## The Fix: Final Content Pass
Implement the final content pass concept in console output, then apply it to the running game in Part 2.

## Your Task
Complete the TODOs to produce the expected console output.

## Beginner Trap
**Polishing mechanics while leaving placeholder text.** "Enemy 1," "Wave N," and "Score: %d" are not player-facing strings. Review every DrawText call and replace debug formatting with polished presentation.

## Elite Insight
QA teams flag placeholder text as a shipping blocker. Nintendo Treehouse reviews every player-facing string. Your content pass follows the same standard: every string the player sees must be intentional and polished.

## Systems Thinking Connection
RPG (L98), Platformer (L98), and Crawler perform the same content pass. Consistent naming, clear messaging, no placeholder text — the checklist is identical across all paths.`,
    starterCode: `#include <iostream>
using namespace std;
int main(){
    cout<<"Final Content Pass"<<endl;
    // TODO: print all final content pass diagnostics
    return 0;
}`,
...
int main(){
    ...
    tests: [
      { id: "t1", description: "final-content-pass line 1", expectedOutput: "Final Content Pass", isPattern: false },
      { id: "t2", description: "final-content-pass line 2", expectedOutput: "Quality: ship-ready", isPattern: false },
    ],
    hints: [
...
Add final content pass to the running game.

## Did It Work?
Console shows the new final content pass output alongside all previous outputs. Canvas shows the game with the new infrastructure active.`,
    starterCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
void hudSystem(World& w){
    DrawText("** SCREENSHOT CAPTURE **",SCREEN_W/2-180,8,18,GOLD);
...
// TODO: Add final content pass — see instructions`,
    solutionCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
int main(){
    ...
    tests: [
      { id: "g1", description: "final-content-pass line 1", expectedOutput: "Final Content Pass", isPattern: false },
      { id: "g2", description: "final-content-pass output", expectedOutput: "ContentAudit: waves=10 types=3 powerups=3 boss=1", isPattern: false },
      { id: "g3", description: "final-content-pass complete", expectedOutput: "Quality: ship-ready", isPattern: false },
