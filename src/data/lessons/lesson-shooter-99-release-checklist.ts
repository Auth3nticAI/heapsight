...
export const lessonShooter99: Lesson = {
  id: "shooter-99-release-checklist",
  title: "Release Checklist",
  description: "v1.0 tag and release notes.",
  order: 99,
  xpReward: 200,
  tier: "pro",
  concepts: ["release", "checklist", "v1.0"],
  part1: {
...
## Mental Model
Shipping is a discipline. Every professional project passes these checks. v1.0 tag and release notes.

## What Breaks Without This
Without a release checklist, you forget to tag, document, or test.

## The Fix: Release Checklist
Implement the release checklist concept in console output, then apply it to the running game in Part 2.
...
RPG (L99), Platformer (L99), and Crawler use the same release checklist pattern. The items differ slightly by genre, but the discipline is identical: systematic verification before shipping.`,
    starterCode: `#include <iostream>
using namespace std;
int main(){
    cout<<"Release Checklist"<<endl;
    // TODO: print all release checklist diagnostics
    return 0;
}`,
...
int main(){
    ...
    tests: [
      { id: "t1", description: "release-checklist line 1", expectedOutput: "Release Checklist", isPattern: false },
      { id: "t2", description: "release-checklist line 2", expectedOutput: "ReleaseReady: true", isPattern: false },
    ],
    hints: [
...
Add release checklist to the running game.

## Did It Work?
Console shows the new release checklist output alongside all previous outputs. Canvas shows the game with the new infrastructure active.`,
    starterCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
void hudSystem(World& w){
    DrawText("** FINAL CONTENT PASS **",SCREEN_W/2-180,8,18,GOLD);
...
// TODO: Add release checklist — see instructions`,
    solutionCode: `#include <iostream>
#include "raylib.h"
#include <cmath>
using namespace std;
...
int main(){
    ...
    tests: [
      { id: "g1", description: "release-checklist line 1", expectedOutput: "Release Checklist", isPattern: false },
      { id: "g2", description: "release-checklist output", expectedOutput: "Release: v1.0 tagged", isPattern: false },
      { id: "g3", description: "release-checklist complete", expectedOutput: "ReleaseReady: true", isPattern: false },
